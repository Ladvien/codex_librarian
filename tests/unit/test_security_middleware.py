...
class TestSecurityHeaders:
    ...
    def test_cors_headers_in_production(self):
        ...
        with patch.dict('os.environ', {'ENVIRONMENT': 'production', 'CORS_ORIGINS': 'https://myapp.com'}):
            client = TestClient(app)
    ...
    def test_correlation_id_header_present(self):
        ...
        assert len(response.headers["X-Correlation-ID"]) > 10  # Should be a UUID-like string
