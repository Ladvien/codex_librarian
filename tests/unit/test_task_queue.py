...
from pdf_to_markdown_mcp.core.exceptions import QueueError, DatabaseError, ValidationError
...
class TestTaskQueue:
    ...
    def test_queue_pdf_processing_with_valid_file(self, task_queue, mock_session, valid_validation_result):
        ...
        with tempfile.NamedTemporaryFile(suffix='.pdf') as temp_file:
            ...
            with patch('pdf_to_markdown_mcp.core.task_queue.DocumentQueries') as mock_doc_queries, \
                ...
                # When (Act)
                result = task_queue.queue_pdf_processing(file_path, valid_validation_result)
    ...
    def test_queue_pdf_processing_with_invalid_validation_result(self, task_queue, valid_validation_result):
    ...
    def test_queue_pdf_processing_with_nonexistent_file(self, task_queue, valid_validation_result):
    ...
    def test_queue_pdf_processing_with_existing_completed_document(self, task_queue, mock_session, valid_validation_result):
    ...
    def test_queue_pdf_processing_with_existing_queued_document(self, task_queue, mock_session, valid_validation_result):
    ...
    def test_queue_pdf_processing_with_celery_task_failure(self, task_queue, mock_session, valid_validation_result):
    ...
    def test_get_queue_status_success(self, task_queue, mock_session):
        ...
        with patch('pdf_to_markdown_mcp.core.task_queue.QueueQueries') as mock_queue_queries:
    ...
    def test_get_queue_status_with_database_error(self, task_queue, mock_session):
        ...
        # Given (Arrange)
        with patch('pdf_to_markdown_mcp.core.task_queue.QueueQueries') as mock_queue_queries:
            mock_queue_queries.get_queue_statistics.side_effect = Exception("Database connection failed")
    ...
    def test_clear_completed_entries(self, task_queue, mock_session):
        ...
        with patch('pdf_to_markdown_mcp.core.task_queue.QueueQueries') as mock_queue_queries:
            ...
            # Then (Assert)
            assert result == 5
            mock_queue_queries.clear_old_entries.assert_called_once_with(mock_session, 7)
    ...
    def test_retry_failed_processing_with_nonexistent_document(self, task_queue, mock_session):
    ...
    def test_retry_failed_processing_with_non_failed_status(self, task_queue, mock_session):
