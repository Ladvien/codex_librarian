...
class WorkerError(PDFToMarkdownError):
    ...
    def __init__(self, message: str, worker_id: Optional[str] = None, task_id: Optional[str] = None, **kwargs):
        super().__init__(message, **kwargs)
...
class ChunkingError(ProcessingError):
    ...
    def __init__(self, message: str, chunk_size: Optional[int] = None, overlap: Optional[int] = None, **kwargs):
        super().__init__(message, **kwargs)
...
class SearchError(PDFToMarkdownError):
    ...
    def __init__(self, message: str, query: Optional[str] = None, search_type: Optional[str] = None, **kwargs):
        super().__init__(message, **kwargs)
        self.query = query
...
def processing_error(message: str, pdf_path: str, stage: Optional[str] = None) -> ProcessingError:
...
def embedding_error(message: str, provider: str, model: str, text_length: Optional[int] = None) -> EmbeddingError:
...
def database_error(message: str, operation: str, table: Optional[str] = None) -> DatabaseError:
...
def resource_error(message: str, resource_type: str, current_usage: Optional[str] = None, limit: Optional[str] = None) -> ResourceError:
